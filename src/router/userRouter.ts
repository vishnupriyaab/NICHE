...
import {_404page,addAddressss,addToWallet,contact,deleteAddress,getHome,getLogin,getShop,getuserLogout,otpSnd,postLogin,resendOtp,testimonial,updateAddress,userProfile,userRegister, wallet, walletRazorpayVerification,} from "../controller/userController/userCtrl";
